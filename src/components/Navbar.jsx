...
const Navbar = () => {
    ...
    return (
        <nav>
            <div className={`navbar bg-[#ffffff] h-[80px] ${!isMobileMenuOpen && "shadow-md"}  flex justify-between items-center px-12 z-10 relative`}>
                <div>
                    <span className="font-serif font-bold text-[#4B682A] text-3xl">GreenNest Naturals</span>
                </div>
                ...
                <div className="flex items-center">
                    ...
                    <a href="#" className="ml-4 px-4 py-2 bg-[#8CB63F] text-white font-bold rounded-full text-sm hidden min-[900px]:flex">Subscribe Now</a>
                    <div className="min-[900px]:hidden ml-5">
                        <button className="items-center flex cursor-pointer" onClick={() => setMobileMenuOpen(!isMobileMenuOpen)}>
                            ...
                            {isMobileMenuOpen && <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-600" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" strokeLinecap="round" strokeLinejoin="round">
                                <path d="M18 6 L6 18" />
                                <path d="M6 6 L18 18" />
                            </svg>}
                        </button>
            ...
            {isMobileMenuOpen && (
                <div className="min-[900px]:hidden mt-4 space-y-1 text-gray-700 font-medium shadow-md px-6 pb-4">
                    <a href="#" className="block text-lg text--700 font-semibold bg-[#F4F7ED] text-[#4B682A] px-3 py-3 rounded-xl">Home</a>
                    ...
                    <div className="flex text-lg items-center space-x-4 mt-2 w-full">
                        <a href="#" className="px-3 py-2 bg-[#81AB45] text-center text-white h-[50px] font-bold w-full rounded-[14px]">Subscribe Now</a>
                    </div>
                </div>
            )}
        </nav>
